...
<head>
    ...
    <!-- Main styles for this apadmin/plication -->
    <link href="{{ asset('admin/dest/style.css') }}" rel="stylesheet">
</head> 
<!-- BODY options, add followingadmin/ classes to body to change options
		1. 'compact-nav'     	admin/  - Switch sidebar to minified version (width 50px)
